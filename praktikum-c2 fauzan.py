print("Nama : Muh Fauzan I'Tisham")
print("Nim  : 231031082")
print("Prodi: Sistem Informasi")
print("Tanggal Lahir : 16-07-2005")
...
hasil = b>7
print(b,"> 7 adalah",hasil)

print("================== Kecil dari 7")
hasil = a<7
print(a,"< 7 adalah",hasil)
hasil = b<=7
print(b,"< 7 adalah",hasil)

print("================== Besar atau sama dari 7")
hasil = a>=2
print(a,">= 2 adalah",hasil)
hasil = b>=7
print(b,">= 7 adalah",hasil)

print("================== Kecil atau sama dari 7")
hasil = a<=2
print(a,"<= 2 adalah",hasil)
hasil = b<=7
print(b,"<= 7 adalah",hasil)
